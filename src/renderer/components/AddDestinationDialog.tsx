    ...
    <div className="modal-backdrop" onClick={handleClose}>
      ...
      >
        <div className="px-6 pt-6 pb-4">
          ...
          <p className="text-[12px] text-gray-500 mt-1">Choose a platform and configure your stream</p>
        </div>

        <form onSubmit={handleSubmit} className="px-6 pb-6 space-y-5">
          {/* Platform grid */}
          <div>
            <label className="block text-[11px] font-semibold text-gray-500 uppercase tracking-widest mb-2.5">
              Platform
            </label>
                    ...
                    <div className="flex flex-col items-center gap-2">
                      ...
                      <span
                        className={`text-[11px] font-medium transition-colors duration-200 ${
                          isSelected ? 'text-gray-200' : 'text-gray-500 group-hover:text-gray-400'
                        }`}
                      >
                        {p.name}
                      </span>
