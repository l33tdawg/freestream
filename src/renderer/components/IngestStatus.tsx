        ...
        <>
          ...
          {hasStats && (
            <div className="mt-2 flex items-start gap-1.5">
              <svg className="w-3 h-3 flex-shrink-0 mt-0.5" style={{ color: 'var(--color-text-faint)' }} fill="currentColor" viewBox="0 0 20 20">
              ...
              <p className="text-[10px] leading-relaxed" style={{ color: 'var(--color-text-faint)' }}>
                This is your source stream. If it matches your destination requirements, no re-encoding is needed — passthrough gives the best quality.
              </p>
            </div>
          )}
